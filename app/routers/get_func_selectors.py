...
async def get_all_func_selectors(
    ...
    try:
        ...
        return parse_obj_as(FunctionSelectorList, {"result": result})
    except Exception as e:
        logging.exception(e)
...
async def get_func_selectors(
    ...
    hexs: List[HexStr] or None = Query(default=None)
...
async def get_func_selector(
    ...
    try:
        ...
        return parse_obj_as(FunctionSelectorResponse, {"result": result})
    except Exception as e:
        logging.exception(e)
